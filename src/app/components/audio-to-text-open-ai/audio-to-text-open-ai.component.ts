...
@Component({
  selector: 'app-audio-to-text-open-ai',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './audio-to-text-open-ai.component.html',
  styleUrl: './audio-to-text-open-ai.component.css',
})
export class AudioToTextOpenAiComponent {
